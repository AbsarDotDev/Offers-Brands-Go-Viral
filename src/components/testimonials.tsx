                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white dark:bg-gray-800 lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj dark:text-white">Everything turned out perfect! She has some of the best templates for just ANYTHING literally 🔥</p>
                                </blockquote>
                            </div>
