...
export default function Header() {
  return (
    <>
      {/* <div className="bg-bgv-skyblue py-2 flex items-center overflow-hidden">
        <Marquee speed={100} className="overflow-hidden">
          <p className="mr-4 text-white font-bold ">
      ...
      <header className="bg-bgv-pink hidden lg:block md:block">
