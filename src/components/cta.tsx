...
export const Cta = ({ heading, paragraph, image, index }: CtaProps) => {
  ...
  return (
    <section className={`bg-white dark:bg-gray-900 pl-5 pr-5`}>
      <div className="gap-8 items-start py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        {isEven ? (
          <>
            <div className="mt-4 md:mt-0 flex flex-col justify-center items-center">
              ...
              <p className="mb-6 font-light text-gray-500  text-lg md:text-xl dark:text-gray-400">{paragraph}</p>
            </div>
            <Image className="w-full animate-fade-left animate-once" src={image} alt="dashboard image" width={1000} height={720} style={{ width: 'auto', height: 'auto' }} />
          </>
        ) : (
          <>
