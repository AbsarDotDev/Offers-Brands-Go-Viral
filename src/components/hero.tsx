...
/> */}
    ...
    {/* <video controls poster='/video-thumb.png' className='rounded-lg'><source src='/brandsgoviral_deals_bundle.mp4'></source></video> */}
        ...
        <h1 className="mb-4 text-center text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white animate-fade-right animate-once">Who Am I?</h1>
        <p className="mb-8 text-center text-lg font-normal text-gray-700 lg:text-xl dark:text-gray-400 animate-fade-right animate-once">Hello! I&apos;m Tiana Davis. I&apos;m <b>Top 1% Seller on Etsy</b> with an exceptional <b>positive rating.</b> I&apos;m a <b>Full-time Etsy seller</b> and have been serving <b>over 5000 satisfied customers,</b> especially <b>estheticians and beauticians,</b> for more than <b>a year.</b> After serving 5000+ Estheticians & Beauticians, I&apos;ve curated the most useful templates into a bundle, offering them in a valuable format. I&apos;m currently offering my best-selling items at discounted prices on my website.

</p>
<h1 className='mb-4 text-xl text-center font-extrabold tracking-tight leading-none text-bgv-black md:text-4xl lg:text-4xl dark:text-white '>IS THIS SOMETHING YOU FEEL A CONNECTION WITH?
...
<Button
      ...
      window.location.href ='https://brandsgoviral.myshopify.com/cart/46879491391776:1?channel=buy_button'
            ...
            className="inline-flex text-lg justify-center font-extrabold items-center py-4 md:py-8 px-5 md:text-2xl text-center text-white rounded-lg bg-gradient-to-r  from-bgv-pink to-bgv-skyblue hover:from-bgv-skyblue hover:to-bgv-pink focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 animate-fade animate-once">
                    I Want To Buy Now
